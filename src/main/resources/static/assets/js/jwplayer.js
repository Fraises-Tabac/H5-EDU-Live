if (typeof jwplayer == "undefined") {
    ...
    (function (a) {
        var c = a.utils;
        a.embed = function (h) {
            var k = {width: 800, height: 600, components: {controlbar: {position: "over"}}};
            ...
            var l = this.resizeMedia = function () {
                ...
                if (W && W.tagName.toLowerCase() == "video") {
                    ...
                    if (j.fullscreen && m.jwGetStretching() == a.utils.stretching.EXACTFIT && !d.isMobile()) {
                        ...
                        d.stretch(a.utils.stretching.EXACTFIT, W, d.parseDimension(U.style.width), d.parseDimension(U.style.height), W.videoWidth ? W.videoWidth : 800, W.videoHeight ? W.videoHeight : 600);
                        b(W, {left: U.style.left, top: U.style.top})
                    } else {
                        if (!c) {
                            d.stretch(m.jwGetStretching(), W, d.getElementWidth(o), d.getElementHeight(o), W.videoWidth ? W.videoWidth : 800, W.videoHeight ? W.videoHeight : 600)
                        }
                    }
                } else {
